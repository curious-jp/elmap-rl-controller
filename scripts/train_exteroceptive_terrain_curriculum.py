...
def train_go1(headless=True):
    ...
    Cfg.terrain.legacy_curriculum = True
    ...
    Cfg.terrain.num_rows= 10 # number of terrain rows (levels = terrain.max_init_terrain_level)
    ...
    Cfg.terrain.difficulty_scale = 0.75 # scales difficulty for curriculum 1.0 ie equivalent with RSL, scales following max values
    ...
    Cfg.terrain.max_platform_height = 0.23 # default 0.2
