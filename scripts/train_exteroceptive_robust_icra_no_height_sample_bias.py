...
def train_go1(headless=True):
    ...
    Cfg.terrain.height_measurements_per_env_xy_noise_std = 0.0
    Cfg.terrain.height_measurements_per_env_z_noise_std = 0.0
    Cfg.terrain.height_measurements_per_env_noise_prob = 0.0
