...
class BaseTask(gym.Env):
    ...
    def __init__(self, cfg, sim_params, physics_engine, sim_device, headless, eval_cfg=None):
        ...
        # if hasattr(cfg.env, 'num_estimator_obs') and cfg.env.num_estimator_obs is not None:
        #     self.num_estimator_obs = cfg.env.num_estimator_obs
        # else:
        #     self.num_estimator_obs = cfg.env.num_observations
        ...
        self.policy_obs_buf = None
        self.estimator_obs_buf = None
