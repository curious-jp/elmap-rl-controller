...
def config_go1(Cnfg: Union[Cfg, Meta]):
    ...
    _.self_collisions = 0  # 1 to disable, 0 to enable...bitwise filter. This has also effect for terminal collisions!
    _.flip_visual_attachments = False
    _.fix_base_link = False

    _ = Cnfg.rewards
    _.soft_dof_pos_limit = 0.9
    _.base_height_target = 0.31 # in nominal position
    ...
    _.num_lin_vel_bins = 30 # NOT used
    _.num_ang_vel_bins = 30 # NOT used
    _.lin_vel_x = [-0.6, 0.6] # NOT used
    _.lin_vel_y = [-0.6, 0.6] # NOT used
    _.ang_vel_yaw = [-1, 1] # NOT used
